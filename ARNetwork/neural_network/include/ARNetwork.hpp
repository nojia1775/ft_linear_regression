...
class	ARNetwork
{
	...
	public:
		...
		std::vector<double>			train(const std::string& loss_functions, const std::string& layer_functions, const std::string& output_functions, const batch_type& inputs, const batch_type& outputs, const size_t& epochs);
